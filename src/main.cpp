...
uint256 hashGenesisBlock("0xe42790de47d58fb5b443a34ab25da86f6008e7a687470ab3fa0a704d72aceed6");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Moneta: starting difficulty is 1 / 2^12
...
{
    // Moneta: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Moneta: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Moneta: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Moneta: 30 Seconds.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Moneta: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe42790de47d58fb5b443a34ab25da86f6008e7a687470ab3fa0a704d72aceed6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1441411201;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2666819;
        ...
        assert(block.hashMerkleRoot == uint256("0x2a9d02b81655adeea0939c2cdd583aa8a4cca05e10bf0ebf5f420b8d409693be"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Moneta: increase each by adding 2 to moneta's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MonetaMiner : ProcessBlock, block not accepted");
    }
...
void static MonetaMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running MonetaMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MonetaMiner terminated\n");
        throw;
    }
}

void GenerateMonetas(bool fGenerate, CWallet* pwallet)
{
